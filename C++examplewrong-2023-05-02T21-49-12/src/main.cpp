...
frontright.spin(forward,Controller1.Axis3.position(percent)-Controller1.Axis1.position(percent),percent);backleft.spin(forward,Controller1.Axis3.position(percent)+Controller1.Axis1.position(percent),percent);
backright.spin(forward,Controller1.Axis3.position(percent)-Controller1.Axis1.position(percent),percent);
Roller.stop();if(
Controller1.ButtonL1.pressing()) {Roller.spin(forward,100,pct);}if(
Controller1.ButtonR1.pressing()&&Controller1.ButtonR2.pressing()){
numatics = 1;
numatic = 1;}}
void driveback(float t) {frontleft.spin(reverse,50,pct);frontright.spin(reverse,50,pct);backleft.spin(reverse,50,pct);
